...
interface IQuizCompleted{
  params: {
    courseId: string;
  };
}

const quizLessonCompletedExemple = {
  id: 1,
...
const quizCompleted = async ({ params } : IQuizCompleted) => {
        ...
        <>
            ...
            <div className="flex flex-col md:px-20 lg:px-40 px-2 py-10 gap-8">
                ...
                <div className="flex gap-8 items-center w-full p-1">
                    <BackButton/>
                    <h1 className="md:text-2xl text-xl font-bold text-(--text)">{quizLessonCompletedExemple.title}</h1>
                </div>

                {/* Details */}
                <QuizClientCompleted quizId={1} isExam></QuizClientCompleted>
